...
// Phone utility functions are now expected to be in window.customerPhoneUtils
...
async function lookupRewards() {
    ...
    const validation = window.customerPhoneUtils.validatePhoneNumber(phoneInput.value);
    ...
    try {
        ...
        const phoneVariations = window.customerPhoneUtils.generatePhoneVariations(phoneNumber);
